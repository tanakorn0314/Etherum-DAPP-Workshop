...
const contractAddress = '0xf5bc2AB1c1AD2950f9FC2d8c73ba477d83Fc2312';
const ABI = [
	{
		"inputs": [],
...
function displayDate() {
    ...
    if (now.valueOf() < closeDate.valueOf()) {
        ...
        const remainHour = Math.floor(diff / 1000 / 60 / 60 % 24).toString().padStart(2, '0');
        const remainMinute = Math.floor(diff / 1000 / 60 % 60).toString().padStart(2, '0');
        const remainSecond = Math.floor(diff / 1000 % 60).toString().padStart(2, '0');
